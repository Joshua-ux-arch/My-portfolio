  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 left-0 w-96 h-96 bg-primary/60 opacity-20 rounded-full blur-3xl" />
        ...
        <FadeIn delay={100}>
          <div className="flex flex-wrap justify-center gap-3 mb-16">
            {categories.map((category) => {
              const Icon = categoryIcons[category] || Target; // ✅ SAFE FALLBACK

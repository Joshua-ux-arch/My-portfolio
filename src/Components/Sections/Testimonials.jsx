      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-normal text-white mb-4 max-w-xl mx-auto">
              Trusted by our forward-thinking teams
            </h2>
        ...
        <FadeIn delay={100}>
          <div className="relative">
                        ...
                        <div className="relative w-full md:w-1/3">
                          <div className="relative h-72 rounded-2xl overflow-hidden">
                            ...
                            <div className="absolute bottom-4 left-4 right-4">
                              <div className="bg-black/60 rounded-xl px-4 py-3 shadow-lg">
            ...
            <button
              ...
              className="flex absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 lg:translate-x-4 items-center justify-center h-10 w-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover:bg-white/20 transition-all duration-300 z-10"
